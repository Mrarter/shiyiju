...
public class ArtworkDetailEntity {
    ...
    private Integer supportGroupBuy;
    private Integer supportResale;
    ...
    public Integer getSupportGroupBuy() { return supportGroupBuy; }
    public void setSupportGroupBuy(Integer supportGroupBuy) { this.supportGroupBuy = supportGroupBuy; }
    public Integer getSupportResale() { return supportResale; }
    public void setSupportResale(Integer supportResale) { this.supportResale = supportResale; }
