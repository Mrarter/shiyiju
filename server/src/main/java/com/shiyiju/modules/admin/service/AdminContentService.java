...
public class AdminContentService {
    ...
    public List<AdminArtworkVO> listArtworks() {
        // 演示模式：始终返回 50 个模拟作品
        return List.of(
            artwork(1L, 1001L, "静谧的山谷", "李明", "¥12,800", 1, "上架", "特价", "当代绘画作品", null),
            artwork(2L, 1002L, "城市光影系列", "王芳", "¥6,800", 2, "上架", "", "城市风光系列", null),
            artwork(3L, 1003L, "水墨山水", "张伟", "¥28,000", 1, "上架", "新品", "传统水墨画", null),
            artwork(4L, 1001L, "抽象艺术 No.7", "李明", "¥15,800", 1, "上架", "特价", "抽象油画", null),
            artwork(5L, 1004L, "海边日落", "陈静", "¥8,800", 1, "上架", "", "风景油画", null),
            artwork(6L, 1005L, "雕塑作品 #3", "赵磊", "¥45,000", 1, "上架", "独家", "青铜雕塑", null),
            artwork(7L, 1002L, "花卉系列", "王芳", "¥5,200", 3, "上架", "", "花卉版画", null),
            artwork(8L, 1003L, "竹林深处", "张伟", "¥19,800", 1, "上架", "热卖", "水墨山水", null),
            artwork(9L, 1006L, "星空之下", "吴敏", "¥22,800", 1, "上架", "", "星空主题画", null),
            artwork(10L, 1007L, "现代都市", "郑强", "¥7,800", 2, "上架", "新品", "都市版画", null),
            artwork(11L, 1008L, "秋日私语", "林立", "¥16,800", 1, "上架", "", "风景油画", null),
            artwork(12L, 1009L, "铜版画 #12", "黄丽", "¥9,800", 1, "上架", "限量", "铜版画", null),
            artwork(13L, 1010L, "烟雨江南", "杨帆", "¥32,000", 1, "上架", "", "水墨画", null),
            artwork(14L, 1011L, "粉色幻想", "马超", "¥12,800", 1, "上架", "", "抽象油画", null),
            artwork(15L, 1012L, "青铜器系列", "徐磊", "¥58,000", 1, "上架", "新品", "青铜雕塑", null),
            artwork(16L, 1013L, "黑白摄影", "钟华", "¥4,200", 5, "上架", "", "摄影版画", null),
            artwork(17L, 1010L, "黄山云海", "杨帆", "¥45,000", 1, "上架", "热卖", "水墨山水", null),
            artwork(18L, 1014L, "晨曦微露", "曾伟", "¥15,800", 1, "上架", "", "风景油画", null),
            artwork(19L, 1009L, "丝网版画", "黄丽", "¥6,800", 2, "上架", "", "丝网版画", null),
            artwork(20L, 1015L, "木雕艺术", "梁勇", "¥36,000", 1, "上架", "", "木雕摆件", null),
            artwork(21L, 1016L, "落日晚霞", "宋涛", "¥18,800", 1, "上架", "特价", "风景油画", null),
            artwork(22L, 1017L, "古韵新风", "卢敏", "¥22,000", 1, "上架", "", "水墨画", null),
            artwork(23L, 1018L, "石版画 #5", "许刚", "¥12,000", 1, "上架", "新品", "石版画", null),
            artwork(24L, 1019L, "夜的旋律", "钱丽", "¥9,800", 1, "上架", "", "夜景油画", null),
            artwork(25L, 1020L, "陶瓷雕塑", "蒋伟", "¥28,000", 1, "上架", "", "陶瓷艺术", null),
            artwork(26L, 1021L, "春意盎然", "沈明", "¥14,800", 1, "上架", "热卖", "风景油画", null),
            artwork(27L, 1022L, "书法小品", "韩静", "¥8,500", 1, "上架", "", "书法作品", null),
            artwork(28L, 1023L, "综合版画", "冯强", "¥5,600", 3, "上架", "", "综合版画", null),
            artwork(29L, 1024L, "雪山之巅", "曹磊", "¥32,000", 1, "上架", "", "风景油画", null),
            artwork(30L, 1025L, "装置艺术", "张莉", "¥68,000", 1, "上架", "独家", "装置艺术", null),
            artwork(31L, 1026L, "金色年华", "程伟", "¥18,800", 1, "上架", "", "人物油画", null),
            artwork(32L, 1027L, "水乡印象", "傅丽", "¥25,800", 1, "上架", "新品", "水墨画", null),
            artwork(33L, 1028L, "限量复刻", "段勇", "¥18,000", 1, "上架", "", "限量版画", null),
            artwork(34L, 1029L, "梦幻泡影", "夏敏", "¥12,800", 1, "上架", "", "抽象油画", null),
            artwork(35L, 1030L, "玉雕摆件", "钟刚", "¥88,000", 1, "上架", "热卖", "玉雕艺术", null),
            artwork(36L, 1031L, "暮色苍茫", "乔磊", "¥15,800", 1, "上架", "", "风景油画", null),
            artwork(37L, 1032L, "行书书法", "翟丽", "¥12,800", 1, "上架", "", "书法作品", null),
            artwork(38L, 1033L, "数字版画", "方伟", "¥3,800", 5, "上架", "特价", "数字艺术", null),
            artwork(39L, 1034L, "荷塘月色", "康静", "¥16,800", 1, "上架", "", "水墨画", null),
            artwork(40L, 1035L, "铁艺雕塑", "史强", "¥42,000", 1, "上架", "", "铁艺艺术", null),
            artwork(41L, 1036L, "都市喧嚣", "薛磊", "¥22,800", 1, "上架", "新品", "都市油画", null),
            artwork(42L, 1037L, "草书长卷", "叶丽", "¥38,000", 1, "上架", "", "书法长卷", null),
            artwork(43L, 1038L, "石版艺术", "蒋伟", "¥15,800", 1, "上架", "", "石版艺术", null),
            artwork(44L, 1039L, "童趣天真", "许静", "¥8,800", 2, "上架", "", "儿童画", null),
            artwork(45L, 1040L, "玻璃艺术", "陆强", "¥35,000", 1, "上架", "热卖", "玻璃雕塑", null),
            artwork(46L, 1041L, "四季如歌", "杜磊", "¥19,800", 1, "上架", "", "风景油画", null),
            artwork(47L, 1042L, "写意山水", "苏丽", "¥42,000", 1, "上架", "精品", "写意山水", null),
            artwork(48L, 1043L, "木刻版画", "韩伟", "¥9,800", 2, "上架", "", "木刻艺术", null),
            artwork(49L, 1044L, "生命之树", "杨静", "¥25,800", 1, "上架", "", "生命主题画", null),
            artwork(50L, 1045L, "玉雕挂件", "朱强", "¥58,000", 1, "上架", "限量", "玉雕挂件", null)
        );
    }
